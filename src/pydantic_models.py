...
class Features(BaseModel):
    ...
    max_players: Optional[int] = Field(alias="Max Players", default=None)
...
class Metrics(BaseModel):
    ...
    review_score: Optional[int] = Field(alias="Review Score", default=None)
    sales_millions_usd: Optional[float] = Field(alias="Sales", default=None)
    used_price_usd: Optional[float] = Field(alias="Used Price", default=None)
...
class PlayStyle(BaseModel):
    ...
    average: float = Field(alias="Average", default=None)
    leisure: float = Field(alias="Leisure", default=None)
    median: float = Field(alias="Median", default=None)
    polled: int = Field(alias="Polled", default=None)
    rushed: float = Field(alias="Rushed", default=None)
